  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
    ...
    <div class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
      <div class="mb-2 flex justify-between items-center">
        <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Original</span>
    ...
    <div class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
      <div class="mb-2 flex justify-between items-center">
        <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Compressed</span>
      ...
      <div class="aspect-video bg-gray-200 dark:bg-gray-800 rounded-lg overflow-hidden flex items-center justify-center relative">
        <img :src="compressedUrl" class="max-w-full max-h-full object-contain" alt="Compressed" />
      </div>
    </div>
  </div>
</template>
